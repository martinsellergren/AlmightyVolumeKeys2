...
class VolumePollingKeyCapture {
    ...
    VolumePollingKeyCapture(MyContext myContext, VolumeKeyInputController volumeKeyInputController) {
        ...
        myContext.deviceState.addMediaStartCallback(this::startPollingAttemptsForAWhile);
